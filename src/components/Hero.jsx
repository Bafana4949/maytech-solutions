...
const Hero = () => {
  ...
  return (
    <section id="home" className="bg-background-light dark:bg-slate-900 pt-24 pb-20 lg:pt-32 lg:pb-32 relative overflow-hidden transition-colors duration-300">
      <TechBackground />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
        ...
        <AnimatedSection animation="animate-[fade-in-up_0.8s_ease-out_forwards]" className="flex flex-col items-center w-full">
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl lg:leading-[1.2] font-extrabold text-primary-navy dark:text-white tracking-tight mb-6 drop-shadow-sm max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 mb-8">
              <a 
                href="#contact" 
                className="inline-flex items-center justify-center px-8 py-4 text-base font-bold rounded-xl text-white bg-primary-blue hover:bg-blue-700 hover:shadow-lg hover:shadow-primary-blue/30 transform hover:-translate-y-1 transition-all duration-300"
              >
                Get a Free Quote
              ...
              <a 
                ...
                className="inline-flex items-center justify-center px-8 py-4 text-base font-bold rounded-xl text-white bg-green-600 hover:bg-green-500 hover:shadow-lg hover:shadow-green-500/30 transform hover:-translate-y-1 transition-all duration-300 shadow-sm"
              >
          ...
          <div className="flex flex-wrap justify-center max-w-4xl gap-3">
            {highlights.map((highlight, idx) => (
              <div key={idx} className="flex items-center text-sm font-medium text-primary-navy dark:text-gray-200 bg-white dark:bg-slate-800/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-gray-100 dark:border-slate-700 shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 hover:border-primary-blue/30 dark:hover:border-accent-cyan/30">
                <highlight.icon className="w-4 h-4 mr-2 text-primary-blue dark:text-accent-cyan" />
                {highlight.text}
              </div>
            ))}
          </div>
